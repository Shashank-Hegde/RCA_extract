...
from train_hybrid2 import SymptomNetHybrid, ENCODER_NAME
from transformers import AutoTokenizer
from sklearn.preprocessing import LabelEncoder

def load_model():
    lbl_enc = torch.load("models/label_encoder.pt")
    n_feats = feature_utils.transform({}, "models/feature_encoder.pkl").shape[1]
...
def main(path):
    ...
    X_feat = feature_utils.transform(j["extracted"], "models/feature_encoder.pkl")
